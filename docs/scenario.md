...
- [x] Gradual Data Drift increases input change: input score 0.0 -> 100.0
- [x] Model Change creates the largest behavior jump: max Model Change behavior score = 91.7
- [x] Recovery lowers behavior change: final Recovery behavior score = 0.0
- [x] Behavior signal is visible before quality proxy fully drops: behavior score rises during Gradual Data Drift while quality remains delayed
